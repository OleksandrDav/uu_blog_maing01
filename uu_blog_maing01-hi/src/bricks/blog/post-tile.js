          ...
          return (
            ...
            >
              ...
              <Box significance="distinct">
                ...
                {(currentUserId === post.creatorIdentity) && <Button onClick={() => handleDeleteProduct(post.id)} icon="mdi-delete" significance="subdued" tooltip="Delete" className={Css.tileIcon()} />}
              </Box>
            </Grid>
          );
        }}
